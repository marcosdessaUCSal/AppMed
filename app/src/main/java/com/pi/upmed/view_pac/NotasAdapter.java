...
public class NotasAdapter extends RecyclerView.Adapter<NotasAdapter.ViewHolder> {
    ...
    private EstruturaNotasPac pacoteNotas;
    ...
    public NotasAdapter(EstruturaNotasPac notas) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        autor.setText(pacoteNotas.getElemento(position).getNomePac() +
                " (" + pacoteNotas.getElemento(position).getLoginPac() + ")\n" +
